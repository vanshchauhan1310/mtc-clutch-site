    ...
    <>
      ...
      <div className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
        ...
        <section className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24 relative z-20">
          <div className="mx-auto gap-8 flex max-w-[58rem] flex-col space-y-4 px-4">
            <MagicCard className="p-4 sm:p-6 opacity-90">
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
                <div className="flex-1 text-left space-y-4">
                  <h2 className="font-bold text-xl sm:text-3xl md:text-6xl text-center sm:text-left">About Us</h2>
                  <div className="text-muted-foreground text-sm sm:text-base">{siteConfig.about}</div>
                </div>
        ...
        <section className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-24">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center px-4">
            ...
            <div className="w-full space-y-4">
              {blogs?.map((e, index) => (
                <MagicCard key={index} className="opacity-95 w-full max-w-md mx-auto rounded-[20px] shadow-[0_4px_10px_#262626,0_-4px_10px_#FE8BBB]">
      ...
      <div className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
        {/* Radial gradient for the container to give a faded look */}
        <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
        <section className="container bg-slate-50 py-16 dark:bg-transparent lg:py-20 mb-24 md:mb-16">
          <div className="mx-auto flex max-w-[72rem] flex-col items-center space-y-8 px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
              {siteConfig.sponsers.map((sponsor, index) => (
                <MagicCard
                  key={index}
                  className="w-full opacity-95 transform transition-transform hover:scale-105 shadow-[0_4px_10px_#262626,0_-4px_10px_#FE8BBB] h-fit"
                >
